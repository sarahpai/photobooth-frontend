 ...
 function xa(a) {
 	...
 	for (m = 0; m < e; ++m) {
 		...
 		for (h = x = 0; h < d; ++h) x += f[h] * Math.pow(2, -h -
 			1);
 		t = 0 === x && 0 === q ? 0 : t * (1 + x) * Math.pow(2, 1 + q - Math.pow(2, a - 1));
 		g[m] = t
 	}
 	return g
 }
 var l = function () {
 		...
 		function d(a) {
 			void 0 === a.Y && (a.Y = "precision lowp float;attribute vec2 a0;varying vec2 vv0;void main(){gl_Position=vec4(a0,0.,1.),vv0=a0*.5+vec2(.5,.5);}");
 			void 0 === a.sa && (a.sa = ["a0"]);
 			void 0 === a.ea && (a.ea = [2]);
 			if (void 0 === a.precision || "highp" === a.precision) a.precision = q;
 			a.id = k++;
 			void 0 !== a.Lc && a.Lc.forEach(function (b, d) {
 			...
 			if (a.h) {
 				...
 				f = a;
 				g = a.id;
 				for (var d in a.h) c.uniform1i(a.m[d],
 					a.h[d])
 			}
 			a.Dd = !0
 		}
 		...
 		function e(a) {
 			ya.Rc(K);
 			g !== a.id && (K.R(), g = a.id, f = a, c.useProgram(a.Ba), a.fa.forEach(function (a) {
 		...
 		var g = -1,
 			...
 			K = {
 				...
 				R: function () {
 					-1 !== g && (g = -1, f.fa.forEach(function (a) {
 	...
 	Ba = function () {
 		...
 		var b = !1,
 			...
 			m = {
 				...
 				l: function (d) {
 					d.fc && !d.ia ? b = document.getElementById(d.fc) : d.ia && (b = d.ia);
 					...
 					var e = {
 						...
 						k;
 					if (k = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) k = navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/), k = 12 === parseInt(k[1], 10);
 					k || (c = b.getContext("webgl2", e));
 					c ? f = !0 : ((c = b.getContext("webgl", e)) || (c = b.getContext("experimental-webgl",
 						e)), f = !1);
 					if (!c) return a("WebGL is not enabled");
 					(g = c.getExtension("WEBGL_lose_context")) && b.addEventListener("webglcontextlost", d.Hc, !1);
 					if (!z.l()) return a("Not enough capabilities");
 					if (!z.ac() && f) return a("Your configuration cannot process color buffer float");
 	...
 	M = function () {
 		var a, b, d = 0,
 			...
 			k = {
 				...
 				l: function () {
 					f || (a = c.createBuffer(), c.bindBuffer(c.ARRAY_BUFFER, a), c.bufferData(c.ARRAY_BUFFER, new Float32Array([-1,
 						-1, 3, -1, -1, 3
 					]), c.STATIC_DRAW), b = c.createBuffer(), c.bindBuffer(c.ELEMENT_ARRAY_BUFFER, b), c.bufferData(c.ELEMENT_ARRAY_BUFFER, new Uint16Array([0, 1, 2]), c.STATIC_DRAW), k.ga_(), f = !0)
 				},
 				a: function (a) {
 					var b = d++,
 						f = a.ca.length,
 					...
 					c.bufferData(c.ARRAY_BUFFER, a.Mb instanceof Float32Array ? a.Mb : new Float32Array(a.Mb), c.STATIC_DRAW);
 					e = b;
 					if (a.ca) {
 						...
 						c.bufferData(c.ELEMENT_ARRAY_BUFFER, a.ca instanceof u ? a.ca : new u(a.ca), c.STATIC_DRAW);
 						g = b
 					}
 					var C = {
 						$b: function (a) {
 				...
 				ga_: function () {
 					-1 !==
 						e && (c.bindBuffer(c.ARRAY_BUFFER, a), e = -1); - 1 !== g && (c.bindBuffer(c.ELEMENT_ARRAY_BUFFER, b), g = -1)
 				},
 				g: function (a, b) {
 					a && M.ga_();
 					b && ya.oa();
 			...
 			a: function (d) {
 				...
 				var A = {
 					...
 					Pb: function () {
 						...
 						c.framebufferRenderbuffer(b, c.DEPTH_ATTACHMENT, c.RENDERBUFFER,
 							t);
 						c.clearDepth(1)
 					},
 					bind: function (a, d) {
 					...
 					rtt: function (a) {
 						e = a;
 						g.v !== u && (c.bindFramebuffer(c.FRAMEBUFFER,
 							h), g.v = u);
 						a.j()
 					},
 					I: function () {
 					...
 					resize: function (a, b) {
 						f = a;
 						q = b;
 						t && (c.bindRenderbuffer(c.RENDERBUFFER, t), c.renderbufferStorage(c.RENDERBUFFER, c.DEPTH_COMPONENT16, f, q))
 					},
 					remove: function () {
 						c.bindFramebuffer(b, h);
 						c.framebufferTexture2D(b, c.COLOR_ATTACHMENT0, c.TEXTURE_2D, null, 0);
 						t && c.framebufferRenderbuffer(b, c.DEPTH_ATTACHMENT, c.RENDERBUFFER, null);
 						c.bindFramebuffer(b, null);
 	...
 	V = function () {
 		...
 		function b(a) {
 			...
 			var b = a >> 16 & 32768,
 				d = a >> 12 & 2047,
 				L = a >> 23 & 255;
 			return 103 > L ? b : 142 < L ? b | 31744 | ((255 == L ? 0 : 1) && a & 8388607) : 113 > L ? (d |= 2048, b | (d >> 114 -
 				L) + (d >> 113 - L & 1)) : b = (b | L - 112 << 10 | d >> 1) + (d & 1)
 		}
 			...
 			Q = {
 				l: function () {
 					if (!B) {
 						...
 						m = [c.TEXTURE0, c.TEXTURE1, c.TEXTURE2, c.TEXTURE3, c.TEXTURE4, c.TEXTURE5, c.TEXTURE6, c.TEXTURE7];
 				...
 				pc: function (b, d, e) {
 					...
 					g !== Math.floor(g) && (c.texParameteri(c.TEXTURE_2D, c.TEXTURE_WRAP_S, c.CLAMP_TO_EDGE), c.texParameteri(c.TEXTURE_2D, c.TEXTURE_WRAP_T, c.CLAMP_TO_EDGE));
 				...
 				a: function (b) {
 					function f() {
 						...
 						b.isPot ? (c.texParameteri(c.TEXTURE_2D, c.TEXTURE_WRAP_S, b.ub ? c.MIRRORED_REPEAT : c.REPEAT), c.texParameteri(c.TEXTURE_2D,
 							c.TEXTURE_WRAP_T, b.U ? c.MIRRORED_REPEAT : c.REPEAT)) : (c.texParameteri(c.TEXTURE_2D, c.TEXTURE_WRAP_S, c.CLAMP_TO_EDGE), c.texParameteri(c.TEXTURE_2D, c.TEXTURE_WRAP_T, c.CLAMP_TO_EDGE));
 						b.wa && "undefined" !== typeof JESETTINGS && c.texParameterf(c.TEXTURE_2D, JEContext.vd().TEXTURE_MAX_ANISOTROPY_EXT, JESETTINGS.bd);
 						c.texParameteri(c.TEXTURE_2D, c.TEXTURE_MAG_FILTER, b.isLinear ? c.LINEAR : c.NEAREST);
 						b.isLinear ? c.texParameteri(c.TEXTURE_2D, c.TEXTURE_MIN_FILTER, b.isMipmap && !ka ? c.NEAREST_MIPMAP_LINEAR : c.LINEAR) : c.texParameteri(c.TEXTURE_2D,
 							c.TEXTURE_MIN_FILTER, b.isMipmap && !ka ? c.NEAREST_MIPMAP_NEAREST : c.NEAREST);
 						S = u[b.ma - 1];
 						P = A[b.ma - 1];
 						U = x[t];
 						if (z.o()) {
 						...
 						if (b.G && !b.isFloat || b.isFloat && b.isMipmap && za.Ac())(d = c.RGBA16F) && (P = d), U = z.va();
 						...
 						if (b.D) c.texImage2D(c.TEXTURE_2D, 0, P, S, U, b.D);
 							...
 							try {
 								...
 								c.getError() !== c.NO_ERROR && (c.texImage2D(c.TEXTURE_2D, 0, P, n, r, 0, S, U, null), c.getError() !== c.NO_ERROR && c.texImage2D(c.TEXTURE_2D, 0, c.RGBA, n, r, 0, c.RGBA, c.UNSIGNED_BYTE, null))
 							} catch (cb) {
 					...
 					"undefined" ===
 					typeof b.isLinear && (b.isLinear = !1);
 					...
 					var N = c.createTexture(),
 						...
 						H = q++,
 						ma = !1,
 						D, Y, ja, ea, P, S, U, ba = b.isFlipY,
 						ka = b.G && b.isMipmap && "undefined" !== typeof za && !za.cc() ? !0 : !1,
 						la, Z = -1,
 						qa = !1;
 					"undefined" !== typeof b.width && b.width && (n = b.width, r = "undefined" !== typeof b.height && b.height ? b.height : n);
 					var J = {
 						get: function () {
 							return N
 						},
 						...
 						kb: function (b) {
 							if (ka) {
 								...
 								var d, e = n,
 									f = r;
 								for (d = 1; d <= b; ++d) e /= 2, f /= 2, l.P("u7", .25 / e, .25 / f), c.viewport(0, 0, e, f), a(la[d - 1]), c.framebufferTexture2D(w.aa(), c.COLOR_ATTACHMENT0,
 									c.TEXTURE_2D, la[d], 0), M.g(!1, 1 === d);
 								h[0] = -1
 							} else J.Oa()
 						},
 						Da: function (a) {
 						...
 						j: function () {
 							c.framebufferTexture2D(w.aa(), c.COLOR_ATTACHMENT0, c.TEXTURE_2D, N, 0)
 						},
 						A: function () {
 							c.viewport(0, 0, n, r);
 							c.framebufferTexture2D(w.aa(), c.COLOR_ATTACHMENT0, c.TEXTURE_2D, N, 0)
 						...
 						Zd: function () {
 							c.framebufferTexture2D(w.aa(), c.COLOR_ATTACHMENT0, c.TEXTURE_2D,
 								null, 0)
 						},
 						resize: function (a, b) {
 							n = a;
 						...
 						refresh: function () {
 							...
 							L ? c.texImage2D(c.TEXTURE_2D, 0, P, S, c.UNSIGNED_BYTE, b.D) : c.texImage2D(c.TEXTURE_2D, 0, P, n, r, 0, S, U, G);
 							ba && c.pixelStorei(c.UNPACK_FLIP_Y_WEBGL,
 								!1)
 						},
 						fb: function () {
 							var a = n * r * 4;
 							Y = [new Uint8Array(a), new Uint8Array(a), new Uint8Array(a), new Uint8Array(a)];
 							D = [new Float32Array(Y[0].buffer), new Float32Array(Y[1].buffer), new Float32Array(Y[2].buffer), new Float32Array(Y[3].buffer)];
 						...
 						Gb: function () {
 							...
 							var a, b = n * r,
 								d = 2 * b,
 								e = 3 * b;
 							for (a = 0; a < b; ++a) D[0][a] = ea[a], D[1][a] = ea[a + b], D[2][a] = ea[a + d], D[3][a] = ea[a + e];
 							return D
 						},
 						gb: function () {
 							w.I();
 							...
 							for (var a = 0; 4 > a; ++a) c.viewport(0, r * a, n, r), l.Jb("u8", aa[a]), M.g(!1, 0 === a)
 						},
 						$d: function (b) {
 							var d = U === x[0] && !g();
 							a(N);
 							ba && c.pixelStorei(c.UNPACK_FLIP_Y_WEBGL, ba);
 							d ? (ca || (B = document.createElement("canvas"), B.width = n, B.height = r, X = B.getContext("2d"), W = X.createImageData(n, r), ca = !0), W.data.set(b), X.putImageData(W, 0, 0), c.texImage2D(c.TEXTURE_2D, 0, P, S, U, B)) : c.texImage2D(c.TEXTURE_2D, 0, P, n, r, 0, S, U, b);
 							h[k] = H;
 							ba && c.pixelStorei(c.UNPACK_FLIP_Y_WEBGL, !1)
 						},
 						ae: function (b, d) {
 						...
 						Od: function (a, d) {
 							...
 							ma || ("RGBA" === a || "RGBE" === a || "RGBAARRAY" === a ? (Y = new Uint8Array(f), ma = !0) : "JSON" !== a || d || J.fb());
 							w.I();
 							l.set(O);
 							J.b(0);
 							if ("RGBA" === a || "RGBE" === a || "RGBAARRAY" === a) {
 								c.viewport(0, 0, n, r);
 								M.g(!0, !0);
 								c.readPixels(0, 0, n, r, c.RGBA,
 									c.UNSIGNED_BYTE, Y);
 								if ("RGBAARRAY" === a) return {
 									data: Y
 								};
 								C || (F = document.createElement("canvas"), K = F.getContext("2d"), C = !0);
 								F.width = n;
 								F.height = r;
 								...
 								if (d) g = new Float32Array(e), c.viewport(0, 0, n, r), M.g(!0, !0), c.readPixels(0, 0, n, r, c.RGBA, c.FLOAT, g);
 								else {
 									for (g = 0; 4 > g; ++g) c.viewport(0, r * g, n, r), l.Jb("u8", aa[g]), M.g(!g, !g);
 									J.Gb();
 									g = Array(e);
 									for (O = 0; O < e; ++O) g[4 * O] = D[0][O], g[4 * O + 1] = D[1][O], g[4 * O + 2] = D[2][O],
 										g[4 * O + 3] = D[3][O]
 								} return {
 								format: a,
 								data: g,
 					...
 					if (b.url) a(N), c.texImage2D(c.TEXTURE_2D, 0, c.RGBA, 1, 1, 0, c.RGBA, c.UNSIGNED_BYTE, null), v = new Image, v.kd = "Anonymous", v.crossOrigin = "Anonymous", v.src = b.url, v.onload = function () {
 						n = v.width;
 						r = v.height;
 						f()
 					};
 						...
 						oa()
 					} else b.array ? (b.G && !b.isFloat ? b.array instanceof Uint16Array ? (G = b.array, f()) : e() ? (G = d(b.array), f()) : (f(), Q.pc(J, b.array, ba)) : (G = b.isFloat ? b.array instanceof Float32Array ? b.array : new Float32Array(b.array) : b.array instanceof Uint8Array ? b.array : new Uint8Array(b.array), f()), b.isKeepArray || (G && G !== b.array && (G = null), delete b.array)) : f();
 					J.uc = J.w;
 					R && p && (R(J), R = !1);
 					return J
 				},
 	...
 	z = function () {
 		...
 		var b, d = !1,
 			...
 			B = !0,
 			C = !0,
 			F, K = "undefined" === typeof window ? {} : window,
 			E = {
 				l: function () {
 					if (d) return !0;
 					a();
 				...
 				kc: function () {
 					u = (x = c.getExtension("EXT_color_buffer_float") || c.getExtension("WEBGL_color_buffer_float") || c.getExtension("OES_color_buffer_float")) ?
 						!0 : !1;
 				...
 				ib: function () {
 					if (!e) {
 						this.o() || (g = c.getExtension("OES_texture_float") || c.getExtension("MOZ_OES_texture_float") || c.getExtension("WEBKIT_OES_texture_float"), k = (K.GL_EXT_FLOAT = g) ? !0 : !1);
 						if (k || this.o()) f = c.getExtension("OES_texture_float_linear") || c.getExtension("MOZ_OES_texture_float_linear") || c.getExtension("WEBKIT_OES_texture_float_linear"),
 				...
 				Na: function () {
 					if (!t) {
 						if (!this.o()) {
 							if (m = c.getExtension("OES_texture_half_float") || c.getExtension("MOZ_OES_texture_half_float") || c.getExtension("WEBKIT_OES_texture_half_float")) F = m.HALF_FLOAT_OES, q = !0;
 							K.GL_EXT_HALFFLOAT = m
 						}
 						if (q || this.o()) h = c.getExtension("OES_texture_half_float_linear") || c.getExtension("MOZ_OES_texture_half_float_linear") || c.getExtension("WEBKIT_OES_texture_half_float_linear"), K.GL_EXT_HALFFLOATLINEAR = h;
 						t = !0
 					}
 				},
 				va: function () {
 				...
 				ic: function () {
 					...
 					c.texParameteri(c.TEXTURE_2D, c.TEXTURE_MAG_FILTER, c.NEAREST);
 					c.texParameteri(c.TEXTURE_2D, c.TEXTURE_MIN_FILTER, c.NEAREST);
 					c.texImage2D(c.TEXTURE_2D, 0, E.o() && c.RGBA32F ? c.RGBA32F : c.RGBA, 1, 1, 0, c.RGBA, c.FLOAT, null);
 					c.framebufferTexture2D(w.aa(),
 						c.COLOR_ATTACHMENT0, c.TEXTURE_2D, b, 0);
 					var d = c.checkFramebufferStatus(w.Pa());
 					d !== c.FRAMEBUFFER_COMPLETE && (A = !1);
 					c.texImage2D(c.TEXTURE_2D, 0, E.o() && c.RGBA16F ? c.RGBA16F : c.RGBA, 1, 1, 0, c.RGBA, E.va(), null);
 					c.framebufferTexture2D(w.aa(), c.COLOR_ATTACHMENT0, c.TEXTURE_2D, b, 0);
 				...
 				hc: function () {
 					...
 					b.j();
 					c.flush();
 					c.checkFramebufferStatus(w.Pa()) !== c.FRAMEBUFFER_COMPLETE ? (V.Nc(), C = !1) : C = !0;
 					a.remove();
 					b.remove()
 				},
 				gc: function () {
 			...
 			m = {
 				l: function () {
 					function b(a, b, d, e) {
 						...
 						try {
 							var f = c.getError();
 							f !== c.NO_ERROR && console.log("GLERR in test_mipmapping() :",
 								f);
 						...
 						f = c.getError();
 						f === c.INVALID_OPERATION && "undefined" !== typeof c.PIXEL_PACK_BUFFER && (c.bindBuffer(c.PIXEL_PACK_BUFFER, null), c.readPixels(0, 0, 1, 1, c.RGBA, c.UNSIGNED_BYTE, g), f = c.getError());
 						return f !== c.NO_ERROR ? !1 : 0 !== g[0]
 					}

 					function h(a) {
 						return z.eb() && b(x, c.FLOAT, new Float32Array(f), a) ? (d = 3, !0) :
 							!1
 					}

 					function m(a) {
 						return z.bc() ? b(u, z.va(), new Uint16Array(f), a) || b(u, c.FLOAT, new Float32Array(f), a) ? (d = 2, !0) : !1 : !1
 					}
 					z.ib();
 					z.Na();
 					var x = c.RGBA,
 	...
 	Ga = {
 		a: function (a) {
 			...
 			a.filterBank && (FilterBank.Qd(a.poolType, a.postpreprocessing), FilterBank.Pd(a.density));
 			var b = !1;
 			if (a.mask) {
 				b = !0;
 			...
 			var q = V.a({
 				...
 				h = {
 					...
 					tc: function () {
 						return a.sift ? Sift.la() : a.DWT ? DWT.la() : a.filterBank ? FilterBank.la() : e ? Ja.la() : q
 					},
 					F: function () {
 						w.S();
 						a.blur && (m.A(), l.set("s41"), l.P("u7", 1 / a.size, 1 / a.size), M.g(!1, !0), m.b(0));
 						k && (l.set(k), f && l.u("u28",
 							1 / a.size), q.A(), b && d.b(1), M.g(!1, !1), q.b(0), e ? Ja.Aa(q) : a.sift ? (l.R(), Sift.Aa()) : a.DWT ? (l.R(), DWT.Aa(4)) : a.filterBank && (l.R(), FilterBank.Aa(q)))
 					}
 				};
 			return h
 		}
 	...
 	Ha = {
 		a: function (a) {
 			...
 			var b = [],
 				...
 				e, g, f = !1,
 				k, m = !0,
 				q, h, t = a.isReorganize ? a.isReorganize : !1,
 			...
 			if ("softmax" === a.type) {
 				...
 				a.size = Math.pow(2, Math.ceil(Math.log(Math.sqrt(a.num_classes)) /
 					Math.log(2)));
 			...
 			} else a.cost ? (a.sparsity =
 				"undefined" !== typeof a.sparsity ? a.sparsity : a.W.ba(), m = !1) : "full" === a.connectivityUp && (a.sparsity = a.W.ba());
 			var ja = {
 					elu: "s15",
 					elu01: "s16",
 					relu: "s14",
 			...
 			var T = void 0 !== a.Gc && a.Gc ? !0 : !1,
 				...
 				X = null;
 			T && (ia = "s42" +
 				a.index.toString(), l.pb("s42", ia, [((a.normalization.n - 1) / 2).toFixed(1)]), l.J(ia, [{
 					type: "1i",
 					name: "u1",
 					value: 0
 				}, {
 			...
 			var v = V.a(a.bias),
 				G, n = {
 					...
 					Pc: function () {
 						switch (a.connectivityUp) {
 							...
 							case "full":
 								...
 								break;
 							case "conv":
 								h = a.kernelsNumber, G = Pa.a(a.connectivity), t && (q = V.a({
 									width: Q,
 									isFloat: !0,
 									isFlipY: !1,
 									isPot: !1
 					...
 					F: function (b, d) {
 						C = b;
 						G.X ? (ca.A(), x && v.b(2), G.F(B), ca.b(0), ca.kb(ta), N.A(), x ? l.set("s0") : (l.set("s28"), l.u("u27", sa), v.b(1)),
 							ca.cb(ta, 0), M.g(!1, !1), l.set(ja), T ? ha.j() : R.j(), N.b(0), A && u.jc(), M.g(!1, !1)) : (R.A(), v.b(1), G.F());
 						T && (l.set(ia), X.j(), ha.b(0), M.g(!1, !1), l.set("s43"), l.u("u6", 1), R.j(), X.b(1), M.g(!1, !1));
 						if (m) return W ? (fa.A(), R.b(0), l.set(L), l.P("u7", 1 / a.size, 1 / a.size), M.g(!1, !1), d = fa) : d = R, d.b(0), t && (q.j(), l.set("s22"), l.P("u14", h, Q / h), M.g(!1, !1), d = q, q.b(0)), d;
 						if ("softmax" === a.type) {
 							l.set("s20");
 							R.b(0);
 							F.j();
 							M.g(!1, !1);
 							a.disableNormalize ? b = F : (l.set("s2"), F.b(0), na.b(1), K.j(), M.g(!1, !1), l.set("s0"), g.A(), K.b(0), K.kb(!1),
 								M.g(!1, !1), l.set("s21"), e.A(), K.cb(!1, 0), l.u("u12", R.uc()), g.b(1), M.g(!1, !1), b = e);
 							if (d) {
 								switch (f) {
 									case "cpuRGBAAvg":
 										break;
 						...
 						if (a.cost) {
 							...
 							d = R;
 							a.disableNormalize || (l.u("u4", 1 / a.size), e.A(), R.b(0), M.g(!1, !1), d = e);
 							switch (f) {
 								case "cpuRGBA2Float":
 									d.gb();
 									p = n.Fb(d);
 					...
 					ec: function (h) {
 						...
 						for (h = 0; h < q; ++h) b.push(m + (a.size - 1 - x) * a.size), d.push([-1, -1, -1, -1]), ++m, m === a.size && (m = 0, ++x);
 						a.disableNormalize || (e = V.a({
 							isFloat: !0,
 							isPot: !0,
 							width: a.size
 						}))
 ...
 var La = {
 	...
 	Na = {
 		a: function (a, b) {
 			var d = a.fromLayerSize,
 				...
 				q = d / e,
 				h = V.a(a.weights),
 				t = "s44" + [d.toString(), e.toString(), g.toString(), f.toString(), b].join("_");
 			l.mc(t) || (a = va(b), e = [{
 				type: "1f",
 				name: "u18",
 				value: e
 				...
 				name: "u26",
 				value: d
 			}), d = [(m ? k : g).toFixed(1), a], m && d.push(q.toFixed(1)), l.pb(m ? "s38" : "s37", t,
 				d), l.J(t, e.concat([{
 				type: "1i",
 				name: "u16",
 				value: 0
 	...
 	Ja = function () {
 		...
 		return {
 			...
 			Aa: function (b) {
 				l.set("s35");
 				for (var h = 0; h < a; ++h) g.j(), l.P("u7", d, 0),
 					M.g(e, !1), f.j(), g.b(0), l.P("u7", 0, d), M.g(e, !1), f.b(0);
 				l.set("s34");
 				m.j();
 				b.b(0);
 				M.g(e);
 				l.set("s35");
 				for (h = 0; h < a; ++h) k.j(), m.b(0), l.P("u7", d, 0), M.g(e, !1), m.j(), k.b(0), l.P("u7", 0, d), M.g(e, !1);
 				l.set("s36");
 				q.j();
 				b.b(0);
 				f.b(1);
 ...
 function Xa(a) {
 	...
 	if (a.video.width && a.video.height) {
 		if (a.video.width.ideal && a.video.height.ideal)
 			for (var g = b(a.video.width.ideal).slice(0, 3), f = b(a.video.height.ideal).slice(0, 3), k = 0, m; k < g.length; ++k) {
 				m = g[k];
 				for (var q = 0, h; q < f.length; ++q)
 					if (h = f[q], m !== a.video.width.ideal || h !== a.video.height.ideal) {
 						var t = Math.max(m,
 							h) / Math.min(m, h);
 						t < 4 / 3 - .1 || t > 16 / 9 + .1 || d(function (a) {
 				...
 				if (a.currentTime) {
 					...
 					if (0 === e || 0 === h) g("VIDEO_NULLSIZE");
 						...
 						try {
 							...
 							k && (e.Dc = k, e.dc = k.getCapabilities(), e.Uc = k.getSettings())
 						} catch (x) {}
 						Ta() || Sa() ? a.parentNode && null !== a.parentNode ? (f || b(a, d,
 							e), setTimeout(function () {
 							a.play()
 						}, 100)) : (document.body.appendChild(a), Za(a), f || b(a, d, e), setTimeout(function () {
 ...
 function ab(a, b, d) {
 	...
 	e ? Ua() ? (d && d.video && (Sa() && Ya(d), d.video.width && d.video.width.ideal && (e.style.width = d.video.width.ideal + "px"), d.video.height && d.video.height.ideal && (e.style.height = d.video.height.ideal + "px")), Ra(e, "autoplay"), Ra(e, "playsinline"), d && d.audio ? e.volume = 0 : Ra(e, "muted"), $a(e, a, function () {
 			function g(d) {
 ...
 window.JEEFACEFILTERAPI = function () {
 	...
 	function E() {
 		if (r !== n.pause) {
 			...
 			if (!p.Sa) {
 				...
 				1E3 * a < v.ad || (p.pa.refresh(), p.za += a, l.set("s47"), p.qa.A(), p.pa.b(0), M.g(!1, !1))
 			}
 			if (y.K.length > I.H) y.K.splice(0, y.K.length - I.H);
 			else
 				for (; y.K.length < I.H;) y.K.push(0);
 			if (1 !== y.i)
 				if (Z.every(W)) {
 					for (var b = 0, d = a = 0; d < Z.length; ++d) Z[d].detected > b && (b = Z[d].detected, a = 0);
 					...
 					for (d = y.wb; b < I.H; ++b) {
 						if (W(Z[d]))
 							if (a) {
 								do ++d === y.i && (d = 0); while (W(Z[d]))
 							} else a = !0;
 						y.K[b] = d++;
 						d >= y.i && (d = 0)
 					}
 					y.wb = d
 				} for (a = 0; a < I.H; ++a) y.T = y.K[a], y.Va = (.5 + y.T) / y.i, y.tb = y.K.lastIndexOf(y.T) === a, l.set("s48"), H.$ && l.u("u37", Z[y.T].rz), 1 !== y.i && l.u("u36", y.Va), U.A(), p.qa.b(0), ba.b(1), M.g(!1, !1), U.b(0), ma.F(!1, U);
 			a = Date.now();
 			I.ja = a - I.timestamp;
 			I.timestamp = a;
 			D.nDetectsPerLoop || (a = v.Fa, I.Bb = I.Ab / I.ja, I.Cb = I.Bb * a + I.Cb * (1 - a), I.Db = 1E3 / I.ja, I.da = I.Db * v.Fa + I.da * (1 - v.Fa), I.da > v.Z[1] ? (a = v.ra[1], 1 < y.i && (a += 1, b = Z.filter(Q).length, a *= Math.max(1, b)), I.H = Math.min(I.H + 1, a), I.da = (v.Z[0] +
 				v.Z[1]) / 2) : I.da < v.Z[0] && (I.H = Math.max(I.H - 1, v.ra[0]), I.da = (v.Z[0] + v.Z[1]) / 2));
 			w.I();
 			...
 			for (a = 0; a < y.i; ++a)
 				if (-1 !== y.K.indexOf(a)) {
 					...
 					if (b.ua < v.Ua) H.$ && (d.rz = 0);
 						...
 						h = 1 - ua(Y.translationFactorRange[0], Y.translationFactorRange[1], h);
 						f = 1 - ua(Y.rotationFactorRange[0], Y.rotationFactorRange[1], f);
 						f = h * f * ua(Y.qualityFactorRange[0], Y.qualityFactorRange[1], b.ua);
 						e = g[++Da[e] % g.length] = f;
 						...
 						g = Math.max(g, v.Tb);
 						for (e = 0; e < v.ya; ++e) d.expressions[e] = pa(d.expressions[e], b.jb[e], g);
 						++b.xa
 					}
 				} w.Zc();
 			w.reset();
 	...
 	function aa() {
 		...
 		var b = {
 			...
 			array: function (a) {
 				...
 				return b
 			}(new Float32Array([0, D.borderWidth, D.borderHeight, 0, 0, 0, 0, 0, 0, 0, 0, 0]))
 		};
 		ba = Ea.a(b);
 	...
 	function ja(a) {
 		var b = H.ab;
 		"JSON" !== b.toUpperCase().split(".").pop() && (b += v.save);
 		ra(b, function (b) {
 			b = JSON.parse(b);
 			b.exportData && b.exportData.thetaXYZfactor && (oa = b.exportData.thetaXYZfactor);
 			a(b)
 		})
 	}
 	...
 	function fa() {
 		return la.some(function (a, b) {
 			if (b === y.T) return !1;
 			b = la[y.T];
 			if (b.xa > a.xa || 3 > a.xa || L(b.x / 2, b.M, a.x / 2, a.M) < v.yb * b.M) return !1;
 			var d = ea / P;
 	...
 	function T() {
 		var O = y.T;
 		ba.Qc(1);
 		1 !== y.i && (c.viewport(0, 0, 3, y.i), l.set("s0"), l.Ib("u1", 1), M.g(!1, !1), l.Ib("u1", 0));
 		c.viewport(0, O, 1, 1);
 		l.set("s49");
 		H.$ && l.u("u37", Z[O].rz);
 		1 !== y.i && l.u("u36", y.Va);
 		...
 		l.Sc("u39", e, g, Aa);
 		M.g(!1, !1);
 		y.tb && (c.viewport(1, O, 1, 1), l.set("s50"), M.g(!1, !1), c.viewport(2, O, 1, 1), l.set("s51"), M.g(!1, !1));
 		d += h;
 		d > k && (a += m, d = f, a > u && (a = t, b += q, b > A && (b = x)));
 		e = a + .8 * (Math.random() - .5) * m;
 		g = b + .8 * (Math.random() - .5) * q;
 		Aa = d + .8 * (Math.random() - .5) * h
 	}
 	...
 	function R(a, b) {
 		...
 		b === D && D.nDetectsPerLoop && (I.H = D.nDetectsPerLoop, I.Ab = D.nDetectsPerLoop)
 	}
 	var v = {
 			save: "NNC.json",
 			Vb: 0,
 	...
 	return {
 		init: function (a) {
 			function b() {
 				r !==
 					n.error && 2 === ++e && (X(), ia(), ha(), H.ha && (H.ha(!1, {
 						GL: c,
 						canvasElement: H.N,
 			...
 			if (r !== n.ob) return a.callbackReady && a.callbackReady("ALREADY_INITIALIZED"), !1;
 			r = n.Bc;
 			...
 			"undefined" !== typeof a.maxFacesDetected && (y.i = Math.max(1, a.maxFacesDetected));
 			...
 			var e = 0;
 			a.videoSettings && a.videoSettings.videoElement ? ca(a.videoSettings.videoElement,
 				b) : (a.videoSettings && R(G, a.videoSettings), ta(a.onWebcamAsk, a.onWebcamGet, function (a) {
 				ca(a, b)
 			}));
 			ja(function (a) {
 				if (!sa()) return !1;
 				...
 				l.Rb([{
 					...
 					name: "_",
 					Y: "attribute vec2 a0;void main(){gl_Position=vec4(a0,0.,1.);}",
 					c: "uniform sampler2D u38;const vec4 e=vec4(.25,.25,.25,.25);const vec3 g=vec3(.5,.5,.5);void main(){float a=dot(e,texture2D(u38,vec2(.125,.875))),b=dot(e,texture2D(u38,vec2(.375,.875))),c=dot(e,texture2D(u38,vec2(.625,.875))),d=dot(e,texture2D(u38,vec2(.625,.625)));vec3 f=vec3(a,b,c)*.5+g;gl_FragColor=vec4(f,d);}",
 					f: ["u38"]
 				}, {
 					id: "s51",
 					name: "_",
 					Y: "attribute vec2 a0;void main(){gl_Position=vec4(a0,0.,1.);}",
 					c: "uniform sampler2D u38;const vec4 e=vec4(.25,.25,.25,.25);void main(){float a=dot(e,texture2D(u38,vec2(.25,.25)));gl_FragColor=vec4(a,0.,0.,0.);}",
 					f: ["u38"]
 				}, {
 					id: "s46",
 					name: "_",
 					c: "uniform sampler2D u34;uniform vec2 u46;uniform float u47;varying vec2 vv0;void main(){float g=step(.5,mod(gl_FragCoord.y+1.5,2.)),c=step(.33,vv0.x);vec4 a=texture2D(u34,vv0+u46);a.a=mix(a.a*u47,a.a,c);vec4 d=floor(255.*a),f=255.*(255.*a-d),b=mix(d,f,g)/255.;b.x=mix(step(a.x,1.5),b.x,c),gl_FragColor=b;}",
 					f: ["u34", "u47", "u46"]
 				}]);
 				aa();
 				na();
 		...
 		toggle_pause: function (a) {
 			if (-1 !== [n.play, n.pause, n.V].indexOf(r)) return a ? -1 === [n.play, n.V].indexOf(r) ? a = !1 : (qa && (clearTimeout(qa), qa = !1), J && (window.cancelAnimationFrame(J), J = !1), r = n.pause, a = !0) : a = C(), a
 		},
 		toggle_slow: function (a) {
 			-1 !== [n.play, n.pause, n.V].indexOf(r) && -1 !== [n.play, n.V].indexOf(r) && (r = a ? n.V : n.play)
 		},
